...
public class DatabaseManager {
	...
	*/
	public WeightResult selectWeightByUserId(int uid){
		...
		String sql = "select * from WeightResultsetTable where uid = %d and recorddate = (select max(recorddate) from WeightResultsetTable where uid = %d)" ;
		sql = String.format(sql, uid,uid);
		Cursor cursor = mSQLiteDatabase.rawQuery(sql, null);
		while (cursor != null && cursor.moveToNext()) {
