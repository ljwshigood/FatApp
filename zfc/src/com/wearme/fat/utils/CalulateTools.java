	...
	public static String setUserStatusInfo(Context context,User user,WeightResult weight,int type){
		 ...
		 switch (type) {
	        case 0:
	            ...
	            }else if (3.0 <= weight.getFatContent() && weight.getFatContent() <= 19.0){
	        ...
	        case 1:
	            ...
	            if (weight.getCalorie() < 1400) {
	            	nomalData = context.getString(R.string.srgddfz) ;
	            }else if (1400.0 <= weight.getCalorie() && weight.getCalorie() <= 1600){
	            	nomalData = context.getString(R.string.suggest) ;
	            }else{
	            	nomalData = context.getString(R.string.jqdl) ;
	            }
	        ...
	        case 6:
	            ...
	            if (user.getGender() == 0) { //man
	                ...
	                if (weight.getWeight() < (user.getHeight()  - 115)) {
	                	nomalData = context.getString(R.string.srgddfz);
	                }else if ((user.getHeight() - 115) <= weight.getWeight() && weight.getWeight() <= (user.getHeight() - 100)){
	                	nomalData = context.getString(R.string.suggest);
	                }else{
	                	nomalData = context.getString(R.string.jqdl) ;
	                }
	...
	public static String setNomalData(User user,int type){
		...
		switch (type) {
	        ...
	        case 6:
	            //体重
	            if (user.getGender() == 0) {
	            	nomalData  = (int)((user.getHeight() - 100)*0.8)+"~"+(int)((user.getHeight() - 100)*0.95);
	            }else{
