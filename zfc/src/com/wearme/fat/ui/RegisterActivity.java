...
import com.wearme.fat.bean.User;
import com.wearme.fat.bean.WeightResult;
import com.wearme.fat.db.DatabaseManager;
import com.wearme.fat.utils.DateUtils;
import com.wearme.fat.utils.PictureUtil;
import com.wearme.fat.wheelview.OnWheelScrollListener;
import com.wearme.fat.wheelview.WheelView;
import com.wearme.fat.wheelview.adapter.NumericWheelAdapter;
import com.wearme.fat.wheelview.adapter.TextWheelAdapter;
import com.wearme.fat.widget.CommonDialog;
import com.wearme.fat.widget.Constants;
import com.wearme.fat.widget.RoundImageView;
import com.wearme.fat.widget.SelectPicPopupWindow;
			...
			public void afterTextChanged(Editable s) {
				if(!mEtHeight.getText().toString().trim().equals("")){
					if(mEtSex.getText().toString().equals(sexs[0])){
						...
						mTvSuggestWeight.setText(mContext.getString(R.string.suggest_weight)+(int)((Float.valueOf(mEtHeight.getText().toString().trim()) - 100)*0.8)+"~"+
								(int)((Float.valueOf(mEtHeight.getText().toString().trim()) - 100)*0.95)+"KG");
					}else{
						mTvSuggestWeight.setText((mContext.getString(R.string.suggest_weight)+(int)((Float.valueOf(mEtHeight.getText().toString().trim()) - 100)*0.8)+"~"+
								(int)((Float.valueOf(mEtHeight.getText().toString().trim()) - 100)*0.95)+"KG"));
					}
